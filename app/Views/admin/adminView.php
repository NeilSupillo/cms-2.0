        ...
        <tbody>
            ...
            <?php foreach ($posts as $data) : ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info" href="/project/admin/view?id=<?php echo $data["id"] ?>">View</a>
                        <a class="btn btn-warning" href="/project/admin/edit?id=<?php echo $data["id"] ?>">Edit</a>
                        <a class="btn btn-danger" onclick="showPopup(<?php echo $data["id"] ?>)">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>

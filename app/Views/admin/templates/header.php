...
<body>
    <div class="dashboard d-flex justify-content-between">
        <div class="sidebar bg-dark vh-100">
            <h1 class="bg-primary p-4"><a href="/project/admin" class="text-light text-decoration-none">Dashboard</a></h1>
            <div class="menues p-4 mt-5">
                ...
                <div class="menu mt-5">
                    <a href="/project/admin/logout" class="btn btn-info">Logout</a>
                </div>
